...
const db = new Database(path.join(dataDir, 'turkeyguide.db'));
...
db.prepare('INSERT OR IGNORE INTO book (id) VALUES (1)').run();
...
const defaultContent = {
  ...
  faq: {
    items: [
      { question: 'How do I receive the guide?', answer: 'Immediately after payment you will be redirected to download your PDF. A copy is also accessible via your purchase confirmation.' },
